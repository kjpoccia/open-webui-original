...
app.state.config.RAG_WEB_SEARCH_ALLOWED_DOMAIN_LIST = RAG_WEB_SEARCH_ALLOWED_DOMAIN_LIST
app.state.config.RAG_WEB_SEARCH_BLOCKED_DOMAIN_LIST = RAG_WEB_SEARCH_BLOCKED_DOMAIN_LIST
